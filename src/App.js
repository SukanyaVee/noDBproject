...
class App extends Component {
  ...
  newTran(category,place,amt){
    ...
    this.setState({expenses: this.state.expenses+singTransaction.amount, savings: this.state.income-this.state.expenses})
      ...
      <div className="App">
        ...
        <main>
              ...
              <div display="flex" align-content="space-between">
                ...
                {/* DISPLAYS TOTALS AND STATIC */}
                    <div>
                      ...
                      <h3>Savings: ${this.state.savings}!!!</h3>
                    </div>  
                  
                    {/* DISPLAYS TRANSACTIONS */}
                    <div align="right">
                      <input placeholder=" Enter Month" onChange={event=>{this.setState({tempfilterMonth: event.target.value})}}/>
            ...
            <div>
              ...
              <aside width="200px">
              <br/><input placeholder=" Income" onChange={event=>{this.setState({tempIncome: parseFloat(event.target.value,10)})}}/>
                <button onClick={event=>{this.setState({income: this.state.tempIncome, savings: this.state.tempIncome-this.state.expenses});}}>Set Income</button>
              <br/>
